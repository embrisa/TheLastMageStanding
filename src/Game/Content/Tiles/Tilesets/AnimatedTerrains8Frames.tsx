...
<tileset version="1.5" tiledversion="1.7.2" name="AnimatedTerrains8Frames" tilewidth="32" tileheight="32" tilecount="261" columns="29">
 <image source="AnimatedTerrains8Frames.png" width="928" height="288"/>
 <tile id="29">
  <animation>
