...
<tileset version="1.10" tiledversion="1.11.2" name="AncientRuinsWall8" tilewidth="32" tileheight="32" tilecount="70" columns="10">
 <image source="AncientRuinsWall8.png" width="320" height="224"/>
 <wangsets>
